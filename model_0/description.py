...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {u'camera_data': {'name': 'camera_data', 'clipInput': True, 'n': 68, 'fieldname': 'camera_data', 'w': 21, 'type': 'AdaptiveScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.010221113566212286}, 'tpParams': {'minThreshold': 10, 'activationThreshold': 13, 'pamLength': 2}, 'clParams': {'alpha': 0.0001}},
